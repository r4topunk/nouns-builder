export const governorAbi = [
  ...
  {
    type: 'function',
    name: 'DEFAULT_PROPOSAL_UPDATABLE_PERIOD',
    inputs: [],
  ...
  {
    type: 'function',
    name: 'MAX_PROPOSAL_UPDATABLE_PERIOD',
    inputs: [],
    outputs: [{ name: '', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'view',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_vetoer', type: 'address', internalType: 'address' },
      { name: '_votingDelay', type: 'uint256', internalType: 'uint256' },
      { name: '_votingPeriod', type: 'uint256', internalType: 'uint256' },
      { name: '_proposalThresholdBps', type: 'uint256', internalType: 'uint256' },
      { name: '_quorumThresholdBps', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      {
        name: '_proposerSignatures',
        type: 'tuple[]',
        internalType: 'struct GovernorTypesV1.ProposerSignature[]',
        components: [
  ...
  },
  {
    ...
    inputs: [{ name: '_newDelayedTimestamp', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      ...
      { name: '_calldatas', type: 'bytes[]', internalType: 'bytes[]' },
      { name: '_description', type: 'string', internalType: 'string' },
      { name: '_updateMessage', type: 'string', internalType: 'string' },
    ],
    outputs: [{ name: '', type: 'bytes32', internalType: 'bytes32' }],
    stateMutability: 'nonpayable',
  },
  ...
  {
    type: 'function',
    name: 'updateProposalUpdatablePeriod',
    inputs: [
      {
        name: '_newProposalUpdatablePeriod',
        type: 'uint256',
        internalType: 'uint256',
      },
    ],
  ...
  },
  {
    ...
    inputs: [{ name: '_newQuorumVotesBps', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    name: 'updateVetoer',
    inputs: [{ name: '_newVetoer', type: 'address', internalType: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [{ name: '_newVotingDelay', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [{ name: '_newVotingPeriod', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  {
    type: 'event',
    name: 'ProposalUpdatablePeriodUpdated',
    inputs: [
      {
        name: 'prevProposalUpdatablePeriod',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
      {
        name: 'newProposalUpdatablePeriod',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
  ...
  { type: 'error', name: 'BELOW_PROPOSAL_THRESHOLD', inputs: [] },
  { type: 'error', name: 'CANNOT_DELAY_GOVERNANCE', inputs: [] },
  { type: 'error', name: 'CAN_ONLY_EDIT_UPDATABLE_PROPOSALS', inputs: [] },
  { type: 'error', name: 'DELEGATE_CALL_FAILED', inputs: [] },
  { type: 'error', name: 'EXPIRED_SIGNATURE', inputs: [] },
  { type: 'error', name: 'INITIALIZING', inputs: [] },
  { type: 'error', name: 'INVALID_CANCEL', inputs: [] },
  { type: 'error', name: 'INVALID_DELAYED_GOVERNANCE_EXPIRATION', inputs: [] },
  { type: 'error', name: 'INVALID_PROPOSAL_THRESHOLD_BPS', inputs: [] },
  { type: 'error', name: 'INVALID_PROPOSAL_UPDATABLE_PERIOD', inputs: [] },
  { type: 'error', name: 'INVALID_QUORUM_THRESHOLD_BPS', inputs: [] },
  { type: 'error', name: 'INVALID_SIGNATURE', inputs: [] },
  { type: 'error', name: 'INVALID_SIGNATURE_NONCE', inputs: [] },
  { type: 'error', name: 'INVALID_SIGNATURE_ORDER', inputs: [] },
  ...
  { type: 'error', name: 'INVALID_VOTING_DELAY', inputs: [] },
  { type: 'error', name: 'INVALID_VOTING_PERIOD', inputs: [] },
  { type: 'error', name: 'MUST_PROVIDE_SIGNATURES', inputs: [] },
  { type: 'error', name: 'NOT_INITIALIZING', inputs: [] },
  { type: 'error', name: 'NO_OP_PROPOSAL_UPDATE', inputs: [] },
  ...
  { type: 'error', name: 'ONLY_PROPOSER_CAN_EDIT', inputs: [] },
  { type: 'error', name: 'ONLY_PROXY', inputs: [] },
  { type: 'error', name: 'ONLY_TOKEN_OWNER', inputs: [] },
  { type: 'error', name: 'ONLY_UUPS', inputs: [] },
  { type: 'error', name: 'ONLY_VETOER', inputs: [] },
  { type: 'error', name: 'PROPOSAL_ALREADY_EXECUTED', inputs: [] },
  ...
  { type: 'error', name: 'PROPOSAL_IN_TERMINAL_STATE', inputs: [] },
  { type: 'error', name: 'PROPOSAL_LENGTH_MISMATCH', inputs: [] },
  {
    type: 'error',
    name: 'PROPOSAL_NOT_QUEUED',
    inputs: [{ name: 'proposalId', type: 'bytes32', internalType: 'bytes32' }],
  },
  { type: 'error', name: 'PROPOSAL_TARGET_MISSING', inputs: [] },
  { type: 'error', name: 'PROPOSAL_UNSUCCESSFUL', inputs: [] },
  { type: 'error', name: 'PROPOSER_CANNOT_BE_SIGNER', inputs: [] },
  { type: 'error', name: 'SIGNED_PROPOSAL_MUST_USE_SIGNATURES', inputs: [] },
  { type: 'error', name: 'TOO_MANY_SIGNERS', inputs: [] },
  { type: 'error', name: 'UNSAFE_CAST', inputs: [] },
  { type: 'error', name: 'UNSUPPORTED_UUID', inputs: [] },
  { type: 'error', name: 'VOTES_BELOW_PROPOSAL_THRESHOLD', inputs: [] },
  { type: 'error', name: 'VOTING_NOT_STARTED', inputs: [] },
  { type: 'error', name: 'WAITING_FOR_TOKENS_TO_CLAIM_OR_EXPIRATION', inputs: [] },
] as const
